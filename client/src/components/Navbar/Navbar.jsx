...
import { getCoupons } from "../../redux/slices/coupon/couponSlice";
                      ...
                      {currentCoupon ? (
                        currentCoupon.isExpired ? (
                          <span className="font-bold text-white">
                            The coupon code {currentCoupon.code} has expired
                          </span>
                        ) : (
                          <span className="font-bold text-white">
                            You are saving {currentCoupon.discount}% with coupon
                            code -{" "}
                    ...
                    {user?.user?.type === "admin" ||
                      (user?.user?.type === "manager" && (
                        <Link
                          to="/dashboard"
                          target="_blank"
                          className=" items-center rounded-md border border-transparent bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 hidden sm:inline-flex"
                        >
                          Dashboard
                        </Link>
                      ))}
                      ...
                      {isLoggedIn && (
                        <div className="flex space-x-8">
                          <div className="flex">
                            <Link
                              to="/profile"
                              className="-m-2 p-2 mr-2 text-gray-400 hover:text-gray-600"
